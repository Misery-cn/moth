...
void CDirUtils::list(const std::string& dirpath, std::vector<std::string>* subdir_names, 
						std::vector<std::string>* file_names, std::vector<std::string>* link_names) throw (sys::CSysCallException)
{
...
void CDirUtils::remove(const std::string& dirpath) throw (sys::CSysCallException)
{
...
bool CDirUtils::exist(const std::string& dirpath) throw (sys::CSysCallException)
{
    struct stat buf;
