...
void CMutex::lock() throw (sys::CSysCallException)
{
...
void CMutex::unlock() throw (sys::CSysCallException)
{
...
bool CMutex::try_lock() throw (sys::CSysCallException)
{
...
bool CMutex::timed_lock(uint32_t millisecond) throw (sys::CSysCallException)
{
	int r;
